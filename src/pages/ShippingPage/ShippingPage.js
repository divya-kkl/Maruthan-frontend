    ...
    <div className="shipping-page">
      <div className="shipping-container">
        ...
        <ul className="shipping-list">
          ...
          <li>For urgent delivery requests, please contact us before placing your order at +91-9786221122.</li>
        </ul>
        ...
        <p className="shipping-text">
          If you need assistance regarding international shipping or customs, feel free to contact us at +91-9786221122.
        </p>
      </div>
    </div>
  );
