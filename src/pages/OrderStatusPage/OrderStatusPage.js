    ...
    <div className="order-status-page">
      <div className="order-status-container">
        ...
        <p className="order-status-text">
          At Prince N Princess, we follow a structured and transparent order process to ensure a smooth shopping experience for parents. Below is a clear overview of each stage your order goes through after placement.
        </p>
