    ...
    <div className="about-page">
      <div className="about-container">
        <div className="about-breadcrumb">
          <Link to="/">Home</Link> &middot; <span>About Prince N Princess</span>
        </div>
        
        <h2 className="about-subtitle">About Prince N Princess - Premium Kids Ethnic Wear Manufacturer in India</h2>
        <p className="about-text">
          Prince N Princess is a leading kids ethnic wear manufacturer in India, specializing in premium traditional outfits for newborns, toddlers, and young children. We design and manufacture high-quality Indian ethnic wear that blends cultural heritage with modern comfort and finishing standards. With a strong background in garment manufacturing, our brand focuses exclusively on creating baby silk frocks, traditional cotton dresses, ethnic gowns, and festive wear for kids. Every outfit is crafted in-house by skilled artisans using carefully selected fabrics that are soft, breathable, and suitable for delicate children’s skin.
        </p>
        <p className="about-text">
        ...
        <p className="about-text">
          At Prince N Princess, our vision is to become a trusted and recognized brand in the Indian kids ethnic wear industry by delivering authentic designs, premium manufacturing quality, and customer-focused service. We believe every child deserves to celebrate special moments in comfort, confidence, and traditional elegance.
        </p>

        <hr className="about-divider" />

        <h2 className="about-subtitle">Why Prince N Princess Pattu Dress?</h2>
        <p className="about-text">
          A Pattu Pavadai is more than a dress - it is tradition and celebration woven into silk. At Prince N Princess, we craft each pavadai using premium raw silk and authentic Banarasi silk sourced directly from trusted weaving units. No synthetic substitutes. No compromise on quality. Every piece features pure silk fabric, rich zari borders, elegant colors, and a soft inner lining for complete comfort.
        </p>
        <p className="about-text">
        ...
        <div className="about-baby-friendly-section">
          ...
          <p className="about-text center-text">
            At <span className="about-highlight">Prince N Princess</span>, we believe baby clothing is not just about style - it is about <span className="about-highlight">comfort, safety, and love</span>. That is why we use carefully selected fabrics sourced directly from authentic manufacturers of <span className="about-highlight">Banarasi silk</span> and <span className="about-highlight">100% pure Chettinad cotton</span>.
          </p>
