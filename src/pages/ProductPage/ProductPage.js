    ...
    <>
      <div className="product-page-container">
        ...
        <div className="product-details-section">
          <div className="product-brand">{product.brand || "little RR"}</div>
          ...
          <div className="product-accordions">
              ...
              {openAccordions.includes('description') && (
                <div className="accordion-content">
                  {product.description ? (
                    ...
                    "Dress your little princess in pure elegance with this stunning dress from little RR - trusted by 10L+ happy parents across India."
                  )}
                </div>
              )}
            </div>
            ...
            <div className="accordion-item">
              ...
              {openAccordions.includes('store') && (
                <div className="accordion-content">
                  <p style={{ marginBottom: '15px' }}>Our little RR store is open every day, except on Diwali and Pongal Holidays. We welcome you throughout the year with the same warmth and service. Experience Quality and Craftsmanship at Our Trusted Offline Stores.</p>
